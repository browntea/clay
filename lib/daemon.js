...
// --- Helper: get removed projects filtered by existing paths ---
function getFilteredRemovedProjects() {
...
var relay = createServer({
  ...
  getRemovedProjects: function () { return getFilteredRemovedProjects(); },
  onAddProject: function (absPath) {
    ...
    relay.broadcastAll({
      ...
      removedProjects: getFilteredRemovedProjects(),
    });
