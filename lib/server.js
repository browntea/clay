...
function createServer(opts) {
  ...
  var onSetupTotp = opts.onSetupTotp || null;
  var onShowTotpQr = opts.onShowTotpQr || null;
  var onDisableTotp = opts.onDisableTotp || null;
  var onVerifyTotp = opts.onVerifyTotp || null;
  var onSetAuthMode = opts.onSetAuthMode || null;
