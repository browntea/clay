    ...
    init: function(initOpts) {
      ...
      _initPromise = (async function() {
        ...
        try {
          ...
          var extraRoots = {};
          if (_cwd) extraRoots[_cwd] = [claudeSkillsDir];
          ...
          if (skillsResult && skillsResult.skills) {
            for (var sk = 0; sk < skillsResult.skills.length; sk++) {
              if (skillsResult.skills[sk].name) skillNames.push(skillsResult.skills[sk].name);
            }
          }
