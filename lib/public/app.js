...
// --- DOM refs ---
  ...
  var hubTips = [
    ...
    "Long-running tasks? Use the terminal tab to monitor background processes.",
  ...
  function renderHomeHub(projects) {
    ...
    // Tip refresh button
    var refreshBtn = $("hub-tip-refresh");
    if (refreshBtn && !refreshBtn._hubWired) {
      refreshBtn._hubWired = true;
