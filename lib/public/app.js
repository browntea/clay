...
import { initScheduler, resetScheduler, handleLoopRegistryUpdated, handleScheduleRunStarted, handleScheduleRunFinished, handleLoopScheduled, openSchedulerToTab, isSchedulerOpen, closeScheduler, enterCraftingMode, exitCraftingMode, handleLoopRegistryFiles, getUpcomingSchedules, handleLibraryEntries, handleLibraryEntryContent, handleLibraryLoaded, handleLibraryError } from './modules/scheduler.js';
...
// --- DOM refs ---
  ...
  var _msgCtx = {
    ...
    handleLibraryEntries: handleLibraryEntries,
    handleLibraryEntryContent: handleLibraryEntryContent,
    handleLibraryLoaded: handleLibraryLoaded,
    handleLibraryError: handleLibraryError,
