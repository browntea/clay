...
// --- DOM refs ---
  ...
  // cachedDmConversations, dmRemovedUsers, cachedMatesList, cachedAvailableBuiltins -> store
  var dmKey = null;
  ...
  initAppNotifications({
    ...
    getActiveSessionId: function () { return store.getState().activeSessionId; },
    getCurrentSlug: function () { return store.getState().currentSlug; },
  ...
  initTools({
    ...
    isMateDm: function () { return store.getState().dmMode && dmTargetUser && dmTargetUser.isMate; },
  ...
  initInput({
    ...
    isDmMode: function () { return store.getState().dmMode && !(dmTargetUser && dmTargetUser.isMate); },
    ...
    isMateDm: function () { return store.getState().dmMode && dmTargetUser && dmTargetUser.isMate; },
    getDmMateId: function () { return (store.getState().dmMode && dmTargetUser && dmTargetUser.isMate) ? dmTargetUser.id : null; },
    getMateName: function () { return dmTargetUser ? (dmTargetUser.displayName || "Mate") : "Mate"; },
    getMateAvatarUrl: function () { return document.body.dataset.mateAvatarUrl || ""; },
  ...
  Object.defineProperties(_dmCtx, {
    ...
    dmKey: { get: function() { return dmKey; }, set: function(v) { dmKey = v; }, enumerable: true },
    dmTargetUser: { get: function() { return dmTargetUser; }, set: function(v) { dmTargetUser = v; }, enumerable: true },
  ...
  var _msgCtx = {
    ...
    connectOverlay: connectOverlay,
    $: $,
    // Non-store state (infrastructure / transient DM session vars)
    get ws() { return ws; },
    get dmTargetUser() { return dmTargetUser; },
    set dmTargetUser(v) { dmTargetUser = v; },
    get dmKey() { return dmKey; },
