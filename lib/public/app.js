...
// --- DOM refs ---
  ...
  var loopUiCtx = {
    ...
    getWizardData: function () { return store.getState().wizardData; },
    getExecModalShown: function () { return store.getState().execModalShown; },
    setExecModalShown: function (v) { store.setState({ execModalShown: v }); },
  };
  ...
  initPanels({
    $: $,
    getWs: function () { return ws; },
    getReplayingHistory: function () { return store.getState().replayingHistory; },
