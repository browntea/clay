...
// --- Getters / Setters (delegate to store) ---
export function getLoopActive() { return store.getState().loopActive; }
export function setLoopActive(v) { store.setState({ loopActive: v }); }

export function getLoopAvailable() { return store.getState().loopAvailable; }
export function setLoopAvailable(v) { store.setState({ loopAvailable: v }); }

export function getLoopIteration() { return store.getState().loopIteration; }
export function setLoopIteration(v) { store.setState({ loopIteration: v }); }

export function getLoopMaxIterations() { return store.getState().loopMaxIterations; }
export function setLoopMaxIterations(v) { store.setState({ loopMaxIterations: v }); }

export function getLoopBannerName() { return store.getState().loopBannerName; }
export function setLoopBannerName(v) { store.setState({ loopBannerName: v }); }

export function getRalphPhase() { return store.getState().ralphPhase; }
export function setRalphPhase(v) { store.setState({ ralphPhase: v }); }

export function getRalphCraftingSessionId() { return store.getState().ralphCraftingSessionId; }
export function setRalphCraftingSessionId(v) { store.setState({ ralphCraftingSessionId: v }); }

export function getRalphCraftingSource() { return store.getState().ralphCraftingSource; }
export function setRalphCraftingSource(v) { store.setState({ ralphCraftingSource: v }); }

export function getRalphFilesReady() { return store.getState().ralphFilesReady; }
export function setRalphFilesReady(v) { store.setState({ ralphFilesReady: v }); }

export function getRalphPreviewContent() { return store.getState().ralphPreviewContent; }
export function setRalphPreviewContent(v) { store.setState({ ralphPreviewContent: v }); }

export function getExecModalShown() { return store.getState().execModalShown; }
export function setExecModalShown(v) { store.setState({ execModalShown: v }); }
...
function toggleLoopPopover() {
  ...
  modal.querySelector(".loop-status-dialog-stop").addEventListener("click", function(e) {
    e.stopPropagation();
    closeModal();
    _ctx.showConfirm("Stop the running " + (store.getState().loopBannerName || "loop") + "?", function() {
      var w = _ctx.getWs();
      if (w && w.readyState === 1) {
        w.send(JSON.stringify({ type: "loop_stop" }));
      }
