...
function createXterm() {
  ...
  // WebGL renderer is intentionally NOT loaded: its texture-atlas /
  // composition-event handling desyncs with Korean (and likely other
  // CJK) IME inputs, producing duplicated-text artifacts while typing.
  // Canvas renderer (xterm.js default) handles IME composition via the
  // hidden textarea correctly. Perf difference is negligible at typical
  // terminal sizes.
