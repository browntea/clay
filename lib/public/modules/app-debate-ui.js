...
export function getDebateStickyState() { return store.getState().debateStickyState; }
export function setDebateStickyState(v) { store.setState({ debateStickyState: v }); }
export function getDebateFloorMode() { return store.getState().debateFloorMode; }
export function getDebateConcludeMode() { return store.getState().debateConcludeMode; }
export function getDebateEndedMode() { return store.getState().debateEndedMode; }
