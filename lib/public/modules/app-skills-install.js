...
export function getKnownInstalledSkills() { return store.getState().knownInstalledSkills; }
export function setKnownInstalledSkills(v) { store.setState({ knownInstalledSkills: v }); }
