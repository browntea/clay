...
export function getCurrentModel() { return store.getState().currentModel; }
export function setCurrentModel(v) { store.setState({ currentModel: v }); }
export function getCurrentModels() { return store.getState().currentModels; }
export function setCurrentModels(v) { store.setState({ currentModels: v }); }
export function getCurrentMode() { return store.getState().currentMode; }
export function setCurrentMode(v) { store.setState({ currentMode: v }); }
export function getCurrentEffort() { return store.getState().currentEffort; }
export function setCurrentEffort(v) { store.setState({ currentEffort: v }); }
export function getCurrentBetas() { return store.getState().currentBetas; }
export function setCurrentBetas(v) { store.setState({ currentBetas: v }); }
export function getCurrentThinking() { return store.getState().currentThinking; }
export function setCurrentThinking(v) { store.setState({ currentThinking: v }); }
export function getCurrentThinkingBudget() { return store.getState().currentThinkingBudget; }
export function setCurrentThinkingBudget(v) { store.setState({ currentThinkingBudget: v }); }
...
export function getHeaderContextEl() { return store.getState().headerContextEl; }
export function setHeaderContextEl(v) { store.setState({ headerContextEl: v }); }
export function getRichContextUsage() { return store.getState().richContextUsage; }
export function setRichContextUsage(v) { store.setState({ richContextUsage: v }); }
export function getCtxPopoverVisible() { return store.getState().ctxPopoverVisible; }
