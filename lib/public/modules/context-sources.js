...
function renderEmailDefaultsList() {
  ...
  if (emailAccountList.length === 0) {
    listEl.innerHTML = '<div class="mcp-empty"><p>No email accounts connected.</p><p style="font-size:12px;color:var(--text-dimmer)">Add accounts in User Settings > Email.</p></div>';
    return;
  }
