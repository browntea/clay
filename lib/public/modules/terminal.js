...
function createXtermForTab(tab) {
  ...
  // WebGL renderer is intentionally NOT loaded: it desyncs with Korean
  // (and likely other CJK) IME composition, producing duplicated-text
  // artifacts while typing. Canvas renderer (xterm.js default) handles
  // IME via the hidden textarea correctly.
