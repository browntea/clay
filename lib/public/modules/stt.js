...
export function initSTT(_ctx) {
  ...
  // nthreads=1: pthread output routing is broken in Worker context
  // (Emscripten reroutes printf internally, bypassing Module.print)
  // Single-thread is slower (~5s encode) but output capture is reliable.
  // TODO: switch to multi-thread when SSL cert is properly trusted
  nthreads = 1;
