...
export function processMessage(msg) {
    ...
    var isMateDm = store.getState().dmMode && _ctx.dmTargetUser && _ctx.dmTargetUser.isMate;
    ...
    switch (msg.type) {
      ...
      case "history_done":
        ...
        if (_hs.currentMsgEl && _hs.currentFullText) {
          ...
          if (replayContentEl) {
            replayContentEl.innerHTML = _ctx.renderMarkdown(_hs.currentFullText);
          }
        }
        ...
        if (!_ctx.isDebateActive()) {
          ...
          if (_ds.debateFloorMode) _ctx.exitDebateFloorMode();
          if (_ds.debateConcludeMode) _ctx.exitDebateConcludeMode();
          if (_ds.debateEndedMode) _ctx.exitDebateEndedMode();
      ...
      case "info":
        ...
        if (store.getState().dmMode && _ctx.dmTargetUser && _ctx.dmTargetUser.isMate) {
          ...
          _ctx.headerTitleEl.textContent = store.getState().projectName;
          var tbProjectName = _ctx.$("title-bar-project-name");
      ...
      case "input_sync":
        if (!store.getState().dmMode) _ctx.handleInputSync(msg.text);
        break;
      ...
      case "session_switched":
        ...
        if (_prevSid && _ctx.inputEl.value) {
          store.getState().sessionDrafts[_prevSid] = _ctx.inputEl.value;
        } else if (_prevSid) {
      ...
      case "status":
        if (msg.status === "processing") {
          ...
          if (!(store.getState().dmMode && _ctx.dmTargetUser && _ctx.dmTargetUser.isMate) && !store.getState().matePreThinkingEl) {
      ...
      case "compacting":
        ...
        } else if (!(store.getState().dmMode && _ctx.dmTargetUser && _ctx.dmTargetUser.isMate)) {
          _ctx.setActivity("thinking");
        }
        break;
      ...
      case "context_usage":
        if (msg.data && !store.getState().replayingHistory) {
          ...
          if (store.getState().ctxPopoverVisible) _ctx.renderCtxPopover();
        }
        break;
      ...
      case "done":
        ...
        if (!store.getState().loopActive) _ctx.enableMainInput();
        _ctx.resetToolState();
        _ctx.stopUrgentBlink();
        if (document.hidden) {
      ...
      case "dm_history":
        ...
        if (store.getState().pendingMateInterview && msg.targetUser && msg.targetUser.isMate && msg.projectSlug) {
          ...
          var checkMateReady = setInterval(function () {
            if (_ctx.ws && _ctx.ws.readyState === 1 && store.getState().mateProjectSlug) {
      ...
      case "dm_message":
        if (store.getState().dmMode && msg.dmKey === _ctx.dmKey) {
          ...
          if (fromId && fromId !== _s1.myUserId) {
            ...
            _ctx.renderUserStrip(_s1.cachedAllUsers, _s1.cachedOnlineIds, _s1.myUserId, _s1.cachedDmFavorites, _s1.cachedDmConversations, _s1.dmUnread, _s1.dmRemovedUsers, _s1.cachedMatesList);
            _ctx.updateDmBadge(fromId, _s1.dmUnread[fromId]);
          }
        }
        break;
      ...
      case "dm_favorites_updated":
        ...
        _ctx.renderUserStrip(_s2.cachedAllUsers, _s2.cachedOnlineIds, _s2.myUserId, _s2.cachedDmFavorites, _s2.cachedDmConversations, _s2.dmUnread, _s2.dmRemovedUsers, _s2.cachedMatesList);
        break;
      ...
      case "mate_deleted":
        ...
        _ctx.renderUserStrip(_s3.cachedAllUsers, _s3.cachedOnlineIds, _s3.myUserId, _s3.cachedDmFavorites, _s3.cachedDmConversations, _s3.dmUnread, _s3.dmRemovedUsers, _s3.cachedMatesList);
        // If currently in DM with this mate, exit DM mode
        if (_s3.dmMode && _ctx.dmTargetUser && _ctx.dmTargetUser.id === msg.mateId) {
          _ctx.exitDmMode();
        }
        break;
      ...
      case "mate_updated":
        if (msg.mate) {
          ...
          _ctx.renderUserStrip(_s4.cachedAllUsers, _s4.cachedOnlineIds, _s4.myUserId, _s4.cachedDmFavorites, _s4.cachedDmConversations, _s4.dmUnread, _s4.dmRemovedUsers, _cml);
          // Update mate sidebar if currently viewing this mate
          if (store.getState().dmMode && _ctx.dmTargetUser && _ctx.dmTargetUser.isMate && _ctx.dmTargetUser.id === msg.mate.id) {
          ...
          if (store.getState().dmMode && _ctx.dmTargetUser && _ctx.dmTargetUser.id === msg.mate.id) {
      ...
      case "mate_list":
        ...
        _ctx.renderUserStrip(_s5.cachedAllUsers, _s5.cachedOnlineIds, _s5.myUserId, _s5.cachedDmFavorites, _s5.cachedDmConversations, _s5.dmUnread, _s5.dmRemovedUsers, _s5.cachedMatesList);
        break;
      ...
      case "debate_preparing":
        if (!store.getState().replayingHistory) _ctx.showDebateSticky("preparing", msg);
      ...
      case "debate_started":
        if (!store.getState().replayingHistory) _ctx.showDebateSticky("live", msg);
        if (store.getState().replayingHistory) {
      ...
      case "debate_conclude_confirm":
        if (!store.getState().replayingHistory) _ctx.showDebateConcludeConfirm(msg);
        break;

      case "debate_user_floor":
        if (!store.getState().replayingHistory) _ctx.showDebateUserFloor(msg);
        break;
      ...
      case "debate_ended":
        if (!store.getState().replayingHistory) _ctx.showDebateSticky("ended", msg);
        if (store.getState().replayingHistory) {
      ...
      case "loop_available":
        ...
        if (_la.loopActive) {
          ...
          if (_la.loopIteration > 0) {
            _ctx.updateLoopBanner(_la.loopIteration, _la.loopMaxIterations, "running");
          }
          _ctx.inputEl.disabled = true;
          _ctx.inputEl.placeholder = (_la.loopBannerName || "Loop") + " is running...";
        }
        break;
      ...
      case "loop_started":
        ...
        _ctx.addSystemMessage((_lbn || "Loop") + " started (max " + msg.maxIterations + " iterations)", false);
        _ctx.inputEl.disabled = true;
        _ctx.inputEl.placeholder = (_lbn || "Loop") + " is running...";
        break;
      ...
      case "loop_iteration":
        ...
        _ctx.addSystemMessage((_libn || "Loop") + " iteration #" + msg.iteration + " started", false);
        _ctx.inputEl.disabled = true;
        _ctx.inputEl.placeholder = (_libn || "Loop") + " is running...";
        break;

      case "loop_judging":
        var _ljs = store.getState();
        _ctx.updateLoopBanner(_ljs.loopIteration, _ljs.loopMaxIterations, "judging");
        _ctx.addSystemMessage("Judging iteration #" + msg.iteration + "...", false);
        _ctx.inputEl.disabled = true;
        _ctx.inputEl.placeholder = (_ljs.loopBannerName || "Loop") + " is judging...";
        break;
      ...
      case "loop_stopping":
        ...
        _ctx.updateLoopBanner(_lss.loopIteration, _lss.loopMaxIterations, "stopping");
        break;
      ...
      case "loop_error":
        _ctx.addSystemMessage((store.getState().loopBannerName || "Loop") + " error: " + msg.text, true);
        break;
      ...
      case "ralph_files_status":
        ...
        if (msg.bothReady) {
          ...
          if (_rfs.ralphPhase === "crafting" || _rfs.ralphPhase === "approval") {
            ...
            if (_rfs.ralphCraftingSource !== "ralph" || _ctx.isSchedulerOpen()) {
              ...
              if (!_ctx.getExecModalShown() && _rfs.ralphCraftingSource === "ralph") {
                _ctx.showExecModal();
              }
            }
          }
      ...
      case "notifications_state":
        _ctx.handleNotificationsState(msg);
        break;
      case "notification_created":
        _ctx.handleNotificationCreated(msg);
        break;
      case "notification_dismissed":
        _ctx.handleNotificationDismissed(msg);
        break;
      case "notification_dismissed_all":
        _ctx.handleNotificationDismissedAll();
        break;
    }
}
