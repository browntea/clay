...
export function processMessage(msg) {
    ...
    switch (msg.type) {
      ...
      // --- Loop Library ---
      case "loop_library_entries":
        _ctx.handleLibraryEntries(msg);
        break;

      case "loop_library_entry_content":
        _ctx.handleLibraryEntryContent(msg);
        break;

      case "loop_library_loaded":
        _ctx.handleLibraryLoaded(msg);
        break;

      case "loop_library_error":
        _ctx.handleLibraryError(msg);
        break;
      ...
      case "loop_available":
        ...
        _ctx.loopLibraryCount = msg.libraryCount || 0;
