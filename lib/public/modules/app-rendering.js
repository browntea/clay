...
// --- State accessors (for app.js re-export) ---
// Store-backed state
export function getCurrentMsgEl() { return store.getState().currentMsgEl; }
export function setCurrentMsgEl(v) { store.setState({ currentMsgEl: v }); }
export function getCurrentFullText() { return store.getState().currentFullText; }
export function setCurrentFullText(v) { store.setState({ currentFullText: v }); }
export function getMatePreThinkingEl() { return store.getState().matePreThinkingEl; }
export function getCurrentMsgTs() { return store.getState().currentMsgTs; }
export function setCurrentMsgTs(v) { store.setState({ currentMsgTs: v }); }
export function getReplayingHistory() { return store.getState().replayingHistory; }
export function setReplayingHistory(v) { store.setState({ replayingHistory: v }); }
// Module-local state
