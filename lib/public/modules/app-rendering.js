...
export function getCurrentMsgEl() { return currentMsgEl; }
export function setCurrentMsgEl(v) { currentMsgEl = v; }
export function getCurrentFullText() { return currentFullText; }
export function setCurrentFullText(v) { currentFullText = v; }
...
export function getMatePreThinkingEl() { return matePreThinkingEl; }
export function getCurrentMsgTs() { return currentMsgTs; }
export function setCurrentMsgTs(v) { currentMsgTs = v; }
export function getIsUserScrolledUp() { return isUserScrolledUp; }
export function setIsUserScrolledUp(v) { isUserScrolledUp = v; }
export function getReplayingHistory() { return replayingHistory; }
export function setReplayingHistory(v) { replayingHistory = v; }
...
function drainStreamTick() {
  ...
  contentEl.innerHTML = _ctx.renderMarkdown(currentFullText);
