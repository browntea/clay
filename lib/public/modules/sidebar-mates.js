...
function showUserCtxMenu(anchorEl, user) {
  ...
  removeItem.addEventListener("click", function (e) {
    ...
    var dr = Object.assign({}, store.getState().dmRemovedUsers); dr[user.id] = true; store.setState({ dmRemovedUsers: dr });
...
function toggleDmUserPicker(anchorEl) {
  ...
  function renderMatesList(filter) {
    ...
    var availBuiltins = store.getState().cachedAvailableBuiltins || [];
    var entries = [];
