...
function toggleDmUserPicker(anchorEl) {
  ...
  function renderMatesDisabledLayout() {
    ...
    promoText.textContent = "AI teammates with distinct roles. Mention them with @ in any session for design, engineering, strategy, or marketing input.";
