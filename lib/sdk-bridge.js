    ...
    if (isMate || mateDisplayName) {
      ...
      if (toolName === "Bash" && input && input.command) {
        ...
        var safeBashCommands = {
          ...
          which: true, type: true, whereis: true,
          echo: true, env: true, printenv: true, pwd: true, whoami: true,
          date: true, uname: true, hostname: true, uptime: true,
          git: true, node: true, python: true, python3: true,
          npm: true, npx: true, yarn: true, pnpm: true,
          cargo: true, go: true, make: true, pip: true, pip3: true,
          jq: true, sort: true, uniq: true, cut: true, tr: true,
          diff: true, md5sum: true, sha256sum: true, base64: true,
        };
